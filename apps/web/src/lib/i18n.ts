...
const zh: Dict = {
  ...
  'detail.experimentLimits': '运行上限：{agents} 个 Agent、{ticks} 个 Tick、{active} 个并发实验',
  ...
  'settings.models.subtitle': '填入服务商的 API 密钥即可使用其模型。',
  'settings.models.edit': '编辑',
  'settings.models.addProvider': '添加提供方',
  'settings.models.customProvider': '添加自定义提供方',
  'settings.models.customSettings': '自定义设置',
  'settings.models.catalog': '模型目录',
  'settings.models.catalogHint': '选择目录中的模型，也可以直接输入模型 ID。',
  'settings.models.fetchModels': '获取可用模型',
  'settings.models.cancel': '取消',
  'settings.models.noModel': '尚未选择模型',
  'settings.models.notConfigured': '尚未配置服务商',
  'settings.api.heading': 'LLM API 配置',
  'settings.api.subtitle': '配置用于智能体仿真的 LLM 服务商。',
  'settings.api.connection': '服务连接',
  'settings.api.generation': '生成参数',
  'settings.api.liveDiscovery': '实时发现',
  'settings.api.liveDiscoveryHint': '服务商列表来自后端；模型会在连接信息变化后自动探测。',
  'settings.api.refreshProviders': '刷新服务商',
  'settings.api.providersUpdated': '服务商列表已更新',
  ...
  'settings.api.timeout': '请求超时（秒）',
  'settings.api.timeoutHint': '单次 Agent 模型调用允许等待的最长时间。',
  'settings.api.retries': '最大尝试次数',
  'settings.api.retriesHint': '遇到临时错误时，包括首次调用在内的尝试次数。',
...
const en: Dict = {
  ...
  'market.loadFailed': 'Failed to load live markets',
  ...
  'detail.experimentLimits': 'Limits: {agents} agents, {ticks} ticks, {active} active experiments',
  ...
  'settings.models.subtitle': 'Add a provider API key to use its models.',
  'settings.models.edit': 'Edit',
  'settings.models.addProvider': 'Add provider',
  'settings.models.customProvider': 'Add custom provider',
  'settings.models.customSettings': 'Custom settings',
  'settings.models.catalog': 'Model catalog',
  'settings.models.catalogHint': 'Choose a catalog model or enter a model ID directly.',
  'settings.models.fetchModels': 'Fetch models',
  'settings.models.cancel': 'Cancel',
  'settings.models.noModel': 'No model selected',
  'settings.models.notConfigured': 'No provider configured',
  'settings.api.heading': 'LLM API Configuration',
  'settings.api.subtitle': 'Configure the LLM provider used for agent simulation.',
  'settings.api.connection': 'Service connection',
  'settings.api.generation': 'Generation controls',
  'settings.api.liveDiscovery': 'Live discovery',
  'settings.api.liveDiscoveryHint': 'Providers come from the server; models refresh automatically when connection details change.',
  'settings.api.refreshProviders': 'Refresh providers',
  'settings.api.providersUpdated': 'Provider list updated',
  ...
  'settings.api.timeout': 'Request timeout (seconds)',
  'settings.api.timeoutHint': 'Maximum time allowed for each agent model request.',
  'settings.api.retries': 'Maximum attempts',
  'settings.api.retriesHint': 'Total attempts, including the first call, for transient failures.',
