...
# Production intentionally requires a Polygon RPC URL. Pytest never contacts
# one, so provide a loopback placeholder instead of weakening Settings.
os.environ.setdefault("POLYMETL_RPC_URL", "http://127.0.0.1:8545")
